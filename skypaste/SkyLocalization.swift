...
enum L10n {
    ...
    private static var bundle: Bundle {
        ...
        guard languageCode != LanguageCatalog.system else { return resourceBundle }

        if let path = resourceBundle.path(forResource: resourceFolderName(for: languageCode), ofType: "lproj"),
